...
const projects = [
    ...
    },
    {
      ...
      smalldesc: "In this game I created the AI for the animals, these creatures had to interact with all the systems in the game that were being developed by my teammates. It took alot of coordination and communication to integrate all the moving parts we were working on.",
    ...
    },
    {
      ...
      smalldesc: "In this project I created my own state machine within the Godot engine in order to create flexible animations and for the character movement controller.",
