    ...
    return(
        <div>
            <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-start p-10">
                ...
                <iframe  allowFullScreen title="revmetrix" className="w-4/5 h-screen" src="https://www.youtube.com/embed/H8Hx7r2bFRE"></iframe>
            ...
            <div className="p-20 text-5xl font-bold bg-gray-900 text-white flex flex-col">
                ...
                <a href="https://github.com/emmetl913/RevMetrixUI-Database"  target="_blank" rel="noopener noreferrer" className="text-center bg-blue-500 hover:bg-blue-900 duration-200 px-16 py-4 transform hover:scale-105">GitHub Page!</a>
