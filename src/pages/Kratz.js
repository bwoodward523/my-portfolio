    ...
    return(
        <div>
            ...
            <div className="p-20 text-5xl font-bold bg-gray-900 text-white flex flex-col">
                ...
                <a href={projects[0].itchio}  target="_blank" rel="noopener noreferrer" className="text-center bg-blue-500 hover:bg-blue-900 duration-200 px-16 py-4 transform hover:scale-105">Itch.io Page!</a>
