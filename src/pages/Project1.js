    ...
    return(
        <div>
            <div className="robotbg min-h-screen bg-gray-100 flex flex-col items-center justify-start p-10">
                <h1 className="text-4xl font-bold text-center text-blue-600">{project.title}</h1>
                <p className="text-center mt-4 text-gray-400" >{project.description}</p>
            ...
            <div className="p-20 text-5xl font-bold bg-gray-900 text-white flex flex-col">
                <p className="text-center text-2xl sm:text-5xl pb-5">{project.placement}</p>
                <a href={project.itchio}  target="_blank" rel="noopener noreferrer" className="text-center bg-blue-500 hover:bg-blue-900 text-xs sm:text-5xl duration-200 px-16 py-4 transform hover:scale-105">Project Submission Page</a>
